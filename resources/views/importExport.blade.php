    ...
    <div class="container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <a href="{{ url('exportUser') }}"><button class="btn btn-success">Download USER xlsx</button></a>

            <a href="{{ url('exportUserByExportable') }}"><button class="btn btn-success">Download USER xlsx (Exportable)</button></a>

            <a href="{{ url('exportExamplePhpSpreadSheet') }}"><button class="btn btn-success">Download exportExamplePhpSpreadSheet</button></a>
