<?php
    ...
    if(!empty($lastInspection)){
        $select_factory_name    = $lastInspection->factory_name;
        $select_size            = $lastInspection->size;
        $select_retest_date     = date('d-m-Y', strtotime($lastInspection->retest_date));
...
@csrf
    ...
    <fieldset class="form-group">
        <div class="row">
            <legend class="col-form-label col-sm-2 pt-0"><strong><font color="blue">Factory ->{{!empty($factory_name_send_back) ? $factory_name_send_back : "null"}} -- {{$select_factory_name}}</font></strong></legend>
            <legend class="col-form-label col-sm-2 pt-0"><strong><font color="blue">Factory ->{{!empty($factory_name_send_back) ? $factory_name_send_back : "null"}} -- {{$select_factory_name}}</font></strong></legend>
            <div class="col-sm-10">
                <div class="form-check custom-control-inline">
                    <input class="form-check-input" type="radio" name="factory_name" id="factory_name1" value="Bangpla" {{ $select_factory_name === "Bangpla" ? "selected" : "" }} required>
                    <label class="form-check-label" for="gridRadios1">
                        Bangpla
                    </label>
                </div>
                <div class="form-check custom-control-inline">
                    <input class="form-check-input" type="radio" name="factory_name" id="factory_name" value="Surat" {{ $select_factory_name === "Surat" ? "selected" : "" }} >
                    <label class="form-check-label" for="gridRadios1">
                        Surat
                    </label>
                </div>
